    ...
    const filteredRosters = () => {
        ...
        prefixes.forEach((prefixDetail) => {
            if(!showOnlyLiveRosters){
                if (prefixDetail.name.toUpperCase().includes(filterInput.toUpperCase().replace(' ', '_'))) {
                    newArray.push(prefixDetail)
                }
            }
            else {
                if (prefixDetail.name.toUpperCase().includes(filterInput.toUpperCase().replace(' ', '_')) && prefixDetail.approved === "true" ) {
                    newArray.push(prefixDetail)
                }
            }
